...
/* Comptes tirés de data/*.json : 11 projets, 6 étapes de parcours, 3 intérêts,
...
const ATTENDU = {
  ...
  'projets.html': { cartes: 11, fiches: 11 },
  'competences.html': { fiches: 11, competences: 14, expertises: 5, savoirEtre: 4 },
